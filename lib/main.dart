...
import 'package:fugacidade/Screens/WelcomeScreen.dart';
import 'package:fugacidade/Tests/PhotoViewExampleScreen.dart';
    ...
    Future.delayed(Duration(milliseconds: 1)).then((value) => {
          SystemChrome.setSystemUIOverlayStyle(
              SystemUiOverlayStyle.dark.copyWith(
                ...
                systemNavigationBarColor: appSecondaryColor,
                systemNavigationBarContrastEnforced: true,
                statusBarBrightness: Platform.isIOS ? Brightness.dark : Brightness.light,
                systemNavigationBarDividerColor: appSecondaryColor,
                systemNavigationBarIconBrightness: Platform.isIOS ? Brightness.dark : Brightness.light,
